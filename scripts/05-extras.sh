...
declare -A urls=(
  ...
  ["rustc-$RUST_VER-x86_64-unknown-linux-gnu.tar.xz"]="$RUST_URL/rustc-$RUST_VER-x86_64-unknown-linux-gnu.tar.xz"
  ...
  ["icu4c-78_2-src.tar.xz"]="$ICU_URL/icu4c-78_2-src.tar.xz"
